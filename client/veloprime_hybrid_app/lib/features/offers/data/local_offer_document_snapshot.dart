  ...
  return OfferDocumentSnapshot(
    ...
    payload: OfferDocumentPayloadData(
      ...
      internal: OfferDocumentInternalSnapshot(
        catalogKey: offer.pricingCatalogKey,
        powertrainType: selectedVersion?.powertrainType,
        year: selectedVersion?.year?.toString(),
        powerHp: selectedVersion?.powerHp,
        systemPowerHp: selectedVersion?.systemPowerHp != null ? '${selectedVersion!.systemPowerHp!.toStringAsFixed(0)} KM' : null,
        batteryCapacityKwh: selectedVersion?.batteryCapacityKwh != null ? '${selectedVersion!.batteryCapacityKwh} kWh' : null,
        combustionEnginePowerHp: selectedVersion?.combustionEnginePowerHp != null ? '${selectedVersion!.combustionEnginePowerHp!.toStringAsFixed(0)} KM' : null,
        engineDisplacementCc: selectedVersion?.engineDisplacementCc != null ? '${selectedVersion!.engineDisplacementCc!.toStringAsFixed(0)} cc' : null,
        driveType: selectedVersion?.driveType,
        rangeKm: selectedVersion?.rangeKm != null ? '${selectedVersion!.rangeKm!.toStringAsFixed(0)} km' : null,
        customerType: offer.customerType,
        finalPriceGross: finalPriceGross,
        finalPriceNet: finalPriceNet,
        selectedColorName: selectedColorName,
